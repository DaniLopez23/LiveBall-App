...
export const PITCH_EVENT_TYPES_CONFIG: {
  ...
  { value: "take_on", label: "Regate", typeIds: ["3"] },
  { value: "abp", label: "ABP", typeIds: ["1", "2"] },
  { value: "shot", label: "Tiro", typeIds: ["13", "14", "15", "16"] },
  { value: "out", label: "Fuera del campo", typeIds: ["5"] },
  { value: "foul", label: "Falta", typeIds: ["4"] },
  { value: "defensive", label: "Defensivo", typeIds: ["7", "8", "12", "44", "49", "67"] },
];

export const EVENT_SUBTYPE_OPTIONS_BY_TYPE: Record<PitchEventType | "all", EventSubtypeOption[]> = {
  all: [
    { id: "pass-cross", typeIds: ["1", "2"], passFlag: "cross", label: "Centro" },
    { id: "pass-long-ball", typeIds: ["1", "2"], passFlag: "long_ball", label: "Pase largo" },
    { id: "pass-head", typeIds: ["1", "2"], passFlag: "head_pass", label: "Pase de cabeza" },
    { id: "pass-through-ball", typeIds: ["1", "2"], passFlag: "through_ball", label: "Pase al espacio" },
    ...
    { id: "pass-chipped", typeIds: ["1", "2"], passFlag: "chipped", label: "Pase picado" },
    { id: "pass-launch", typeIds: ["1", "2"], passFlag: "launch", label: "Envio largo" },
    { id: "pass-flick-on", typeIds: ["1", "2"], passFlag: "flick_on", label: "Prolongacion" },
    { id: "pass-key", typeIds: ["1", "2"], passFlag: "is_key_pass", label: "Pase clave" },
    ...
    { id: "foul", typeIds: ["4"], label: "Falta" },
    { id: "def-tackle", typeIds: ["7"], label: "Entrada" },
    { id: "def-interception", typeIds: ["8"], label: "Intercepcion" },
    { id: "def-duel", typeIds: ["44", "67"], label: "Duelo" },
    { id: "def-clearance", typeIds: ["12"], label: "Despeje" },
    { id: "def-ball-recovery", typeIds: ["49"], label: "Recuperacion de balon" },
  ],
  pass: [
    { id: "pass-cross", typeIds: ["1", "2"], passFlag: "cross", label: "Centro" },
    { id: "pass-long-ball", typeIds: ["1", "2"], passFlag: "long_ball", label: "Pase largo" },
...
export const OUTCOME_OPTIONS_BY_TYPE: Record<PitchEventType | "all", OutcomeOption[]> = {
  all: [
    ...
    { id: "take-on-ok",   typeId: "3",  outcome: 1, label: "Regate acertado" },
    { id: "take-on-fail", typeId: "3",  outcome: 0, label: "Regate fallido" },
    { id: "shot-miss",    typeId: "13",            label: "Fallo" },
    { id: "shot-post",    typeId: "14",            label: "Poste" },
    { id: "shot-saved",   typeId: "15",            label: "Tiro parado" },
    ...
    { id: "def-tackle", typeId: "7", label: "Entrada" },
    { id: "def-interception", typeId: "8", label: "Intercepcion" },
    { id: "def-duel-44", typeId: "44", label: "Duelo" },
    { id: "def-duel-67", typeId: "67", label: "Duelo" },
    { id: "def-clearance", typeId: "12", label: "Despeje" },
    { id: "def-ball-recovery", typeId: "49", label: "Recuperacion de balon" },
  ],
  pass: [
    { id: "pass-ok",      typeId: "1", outcome: 1, label: "Pase exitoso" },
    { id: "pass-fail",    typeId: "1", outcome: 0, label: "Pase fallido" },
